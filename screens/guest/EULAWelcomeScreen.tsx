...
const EULAWelcomeScreen: React.FC<EULAWelcomeScreensProps> = ({
  route,
  navigation,
}: EULAWelcomeScreensProps) => {
    ...
    <SafeAreaView style={styles.container}>
      <ScrollView
        ...
        <View style={{ paddingBottom: 10 }}>
          <Text style={styles.eulaMainHeadline}>You are welcome Here</Text>
...
export const screenOptions = (navigator: EULAWelcomeScreensProps) => {
  return {
...
export default EULAWelcomeScreen;
